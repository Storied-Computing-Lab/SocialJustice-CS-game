label a_The_Base:
    ...
    c "That's terrible! They reall don't think we're smart. Is there anything we can do to stop them?"
    ...
    e "The only problem is, we need the a lot of questions and they need to come from real people"
